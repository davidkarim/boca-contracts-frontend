        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Deploy a smart contract with confidence in seconds. Find your use-case or ask us for a custom contract.</div>
            </div>
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Highlights</h6>
                <ul>
                  <li className="mb-1">
                    <Link href="https://app.bocacontracts.com/contractTemplate/23?type=2" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Smart Wallet</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="https://app.bocacontracts.com/contractTemplate/22?type=1" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Lottery</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="https://app.bocacontracts.com/contractTemplate/21?type=0" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">CrowdFund</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link href="https://twitter.com/bocacontracts" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Boca Contracts. All rights reserved.</div>
